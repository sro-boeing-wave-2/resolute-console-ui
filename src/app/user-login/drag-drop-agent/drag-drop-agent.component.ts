...
export class DragDropAgentComponent {
 ...
 public upload(files) {
  ...
  OnPost()
  {
    this.http.post('http://172.23.238.225:5001/api/agents',{"OrganisationName":"stackroute","email":"stackroute@gmail.in","password":"stackroute1","logoUrl":"logo@stackroute.com"}).subscribe(result =>console.log(result));
  }
 }
